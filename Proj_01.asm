...
.DATA
    ...
    msg8 db 'Deseja realiz outra operacao?(s/n)',10,'$'
...
FIM:
    ...
    MOV AH,09
    LEA DX,msg8
    INT 21h      ;imprime a mensagem pergunta se o usuario deseja realizar mais operacoes

    MOV AH,07
    INT 21h      ;pega o carater digitado pelo usuario
    CMP al,'s'   ;compara esse caracter
    JE SIM
    MOV AH,4CH  ;finaliza o programa
    INT 21H  
SIM:
    JMP REPETE  ;volta para o inicio do programa
    MAIN ENDP
END MAIN